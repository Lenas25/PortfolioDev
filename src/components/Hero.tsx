  ...
  return (
    <section id="hero" className="hero-section">
      ...
      <div className="hero-right">
        {/* Top row: Image + Card 1 */}
        <div className="hero-top-row">
          {/* Profile Image */}
          <div
            className="hero-profile slide-in"
          ...
          {/* Card 1 */}
          <div
            className="hero-card slide-in"
            style={{ animationDelay: "0.3s" }}
          >
            <span className="hero-card-dot" />
            <div className="hero-card-label">{t.card1Label}</div>
            <div className="hero-card-value">{t.card1Value}</div>
            <div className="hero-card-sub">{t.card1Sub}</div>
          </div>
        </div>

        {/* Card 2 */}
        <div
          className="hero-card hero-card--alt slide-in"
          style={{ animationDelay: "0.4s" }}
        >
          <div className="hero-card-label">{t.card2Label}</div>
          <div className="hero-card-value">{t.card2Value}</div>
          <div className="hero-card-sub">{t.card2Sub}</div>
        </div>

        {/* Badges */}
        <div
          className="hero-badges slide-in"
          style={{ animationDelay: "0.5s" }}
        >
          {[
            { icon: "⚡", text: t.badge1 },
      ...
      {/* Scroll indicator */}
      <div className="hero-scroll slide-in" style={{ animationDelay: "0.8s" }}>
        <motion.svg
          width="18"
          height="18"
          fill="none"
